...
- This means that we need to create
  #. models.py: a database to keep track of what's going on + 'tables' in that
  database
  #. routes.py: webpages
  #. templates/*.html: templates for our front-end web pages
  #. some sort of user authentication scheme.
